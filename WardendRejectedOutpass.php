...
<head>
<meta charset="utf-8">
<title>Disapproved Outpasses - OUTPASS MANAGEMENT SYSTEM</title>
...
<body>
<div id="lamhead">
<h2> <span id="head">OUTPASS MANAGEMENT SYSTEM |</span> VIEW DISAPPROVED OUTPASSES</h2></div>
...
<th>outpass id </th>   
 ...
 <?php
	  ...
	  mysql_select_db("outpass");
	   $rows= mysql_query("SELECT * FROM requestwarden where status = 2");
