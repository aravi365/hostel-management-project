...
<head>
<meta charset="utf-8">
<title>Outpass Management System- Add New Department</title>
...
<body>
<div id="lamhead">
<h2> <span id="head">OUTPASS MANAGEMENT SYSTEM |</span> ADD NEW DEPARTMENT</h2></div>
 <img class="back1" src="Picture2.png" width="1366" height="768">
<div id="formwrapper">
<form action="addnewdept.php" method="post">
<fieldset>

<label for="hodname">Dept Name:</label>
<input name="deptname" type="text" size="30" maxlength="30" required placeholder="eg:IT">
<label for="name"> HOD Name:</label>
<input name="hodname" type="text" size="30" maxlength="30" required>



<label for="phone">Phone No:</label>
<input name="phone" type="text" size="10" maxlength="30" required pattern="[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]" placeholder="Do not include +91">
