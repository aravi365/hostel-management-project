...
<div id="lamhead">
<h2> <span id="head">OUTPASS MANAGEMENT SYSTEM  |</span> REQUEST LEAVE</h2></div>
...
<li ><a href="parentNotices.php">Alert Box</a>
...
<div id="formwrapper">
<form action="prequesthod.php"  name = "myForm"onSubmit ="return validateForm()" method="post">
...
<input  id="mov2" name="today" type="text" size="40" maxlength="50" readonly value="<?php  $curdate=date("y/m/d"); echo $curdate ?>">
