...
<table>
 ...
 <?php
	  ...
	  $query = mysql_query("SELECT * FROM student WHERE admno like'$input' or name like '%$input%'");
$numrows =mysql_num_rows($query);
if($numrows == 0)
	header("location:Findstudentinputpageforwarrden.php?abc= Student Does Not Exist");
	else
{
  ...
  <tbody>
    <tr>
	  ...
	  <td><?php echo $mob;  ?></td>
	  	  <td><?php echo $per;  ?></td>
	   <td>	<form action ="ophistory.php"	> <input type ="hidden" name ="admno" value ="<?php echo $user ;?>" > <button >OP History</button> </form> </td>
	 <td>	<form action ="editsp.php"	> <input type ="hidden" name ="admno" value ="<?php echo $user ;?>" > <button >Edit</button> </form> </td>
	<td>	<form action ="deletesp.php"	> <input type ="hidden" name ="admno" value ="<?php echo $user ;?>" >	<button > Delete </button> </form> </td>
	<td>	<form action ="discipline.php"	> <input type ="hidden" name ="admno" value ="<?php echo $user ;?>" >	<button > Disiplinary </button>  </form></td>
