...
<head>
<meta charset="utf-8">
<title>Update Batch-Outpass Mangament System</title>
...
<form action="addbatch2.php" method="post">
<label id="iot1">Add Batch:</label>
<input type="text" name="addbatch1" id="io1" >
<br>
<br>
<br>
<br>
<input type="submit" id="btnadd1" value="Add Batch">




</form>
<form action="deletebatch1.php" method="post">
<label id="iot100">Delete Batch:</label>
<select  id="deletebat" name="delete" required>
<option value="">-------------</option>
<?php

$connect=mysql_connect("localhost","root","") or die("connection terminated");
mysql_select_db("outpass") or die("");
$selectdept=mysql_query("SELECT * FROM batch");
while($row=mysql_fetch_assoc($selectdept))
{
	$batchname = $row['batname'];
	?>
    <option value="<?php echo $batchname;  ?>"><?php echo $batchname;  ?></option>
    <?php
}
...
<br>
<br>
<input type="submit" id="btndelete1" value="Delete Batch">
