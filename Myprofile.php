...
<input id="mov1" name="Sub" type="text" size="40" maxlength="150"  value=" <?php echo $name; ?> ">
<label>Admission No:</label><br><br>
<input id="mov2" name="Sub" type="text" size="40" maxlength="150" readonly value="<?php echo $user; ?>">
<label>Branch:</label><br><br>
<input id="mov3" name="Sub" type="text" size="40" maxlength="150" readonly value="<?php echo $branch; ?>">
<label>Semester:</label><br><br>
<input id="mov4" name="Sub" type="text" size="40" maxlength="150" readonly value="<?php echo $sem; ?>">
<label>Batch:</label><br><br>
<input id="mov5" name="Sub" type="text" size="40" maxlength="150" readonly value="<?php echo $batch; ?>">
<label>Father Name:</label><br><br>
<input id="mov6" name="Sub" type="text" size="40" maxlength="150" readonly value="<?php echo $fname; ?>">
<label>Date Of Birth:</label><br><br>
<input id="mov7" name="Sub" type="text" size="40" maxlength="150" readonly value="<?php echo $dob; ?>">
<label>My Email:</label><br><br>
<input id="mov8" name="Sub" type="text" size="40" maxlength="150" readonly value="<?php  echo $email; ?>">
<label>Father Mob:</label><br><br>

<input id="mov9" name="Sub" type="text" size="40" maxlength="150" readonly value="<?php echo $mob; ?>">
<label></label><br><br>
<input id="mov10" name="Sub" type="text" size="40" maxlength="150" readonly value=" ">
