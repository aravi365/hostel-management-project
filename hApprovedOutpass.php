...
<table>
  ...
  <?php
	  ...
	  $rows=mysql_query("SELECT * from student,requestwarden where student.branch = '$hoddept' and student.admno=requestwarden.admno AND requestwarden.hodapproval=1 and type=1;");
	  mysql_error();
